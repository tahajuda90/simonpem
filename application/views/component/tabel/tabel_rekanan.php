...
<div class="content shadow p-4 my-4">
      <div class="d-flex justify-content-end">
        <button class="btn btn-primary mb-2">
            <a href="<?= base_url('C_Rekanan/create')?>" class="text-decoration-none text-white"
            ...
            <?php if (!empty($rekanan)) {
                foreach ($rekanan as $rkn) {
                    ...
                    <tr>
                        ...
                        <td><a class="btn-xs p-1 btn-warning" href="<?= base_url('C_Rekanan/edit/'.$rkn->id_rekanan)?>"><i class="fa-solid fa-edit"></i>edit</a></td>
                    </tr>
                <?php }
            }
            ?>
