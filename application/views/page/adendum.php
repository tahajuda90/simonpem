        ...
        <nav aria-label="breadcrumb ">
            <ol class="breadcrumb shadow p-3 mb-5 rounded">
                ...
                if(count($this->uri->segment_array())>1){
                    echo '<li class="breadcrumb-item"><a href="'.base_url('adendum').'">Adendum</a></li>
                <li class="breadcrumb-item active" aria-current="page">Data</li>';
                }else{
                    echo '<li class="breadcrumb-item active" aria-current="page">Adendum</li>';
                }
                ?>
